...
CTR_ID=`docker run -d -p 20022:22 -p 127.0.0.1:20080:80 -p 127.0.0.1:23000:3000 -p 127.0.0.1:27070:7070 -p 127.0.0.1:29001:9001 -p 127.0.0.1:29090:9090 "$IMAGE_ID"`
